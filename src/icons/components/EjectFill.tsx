...
const SvgEjectFill = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      d="M5.50102 11.2355C4.0589 13.2184 5.47536 16 7.92722 16L16.0721 16C18.524 16 19.9405 13.2184 18.4984 11.2355L14.4259 5.63588C13.2278 3.98856 10.7715 3.98856 9.57347 5.63588L5.50102 11.2355Z"
      fill="currentColor"
    />
    <path
