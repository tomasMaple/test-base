...
const SvgBlocksViewFill = (props: SVGProps<SVGSVGElement>) => (
  <svg
    fill="currentColor"
  ...
  >
    ...
    />
    <path
      d="M16 15H18C18.5523 15 19 15.4477 19 16V18C19 18.5523 18.5523 19 18 19H16C15.4477 19 15 18.5523 15 18V16C15 15.4477 15.4477 15 16 15Z"
      fill="currentColor"
    />
    <path
      d="M6 15H8C8.55228 15 9 15.4477 9 16V18C9 18.5523 8.55228 19 8 19H6C5.44772 19 5 18.5523 5 18V16C5 15.4477 5.44772 15 6 15Z"
      fill="currentColor"
    />
    <path
      d="M6 5H8C8.55228 5 9 5.44772 9 6V8C9 8.55228 8.55228 9 8 9H6C5.44772 9 5 8.55228 5 8V6C5 5.44772 5.44772 5 6 5Z"
      fill="currentColor"
    />
    <path
      d="M16 5H18C18.5523 5 19 5.44772 19 6V8C19 8.55228 18.5523 9 18 9H16C15.4477 9 15 8.55228 15 8V6C15 5.44772 15.4477 5 16 5Z"
      fill="currentColor"
    />
  </svg>
);
export default SvgBlocksViewFill;
