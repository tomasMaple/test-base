...
const SvgContactAgenda = (props: SVGProps<SVGSVGElement>) => (
  <svg
    fill="currentColor"
  ...
  >
    ...
    />
    <path
      d="M8.12355 15.0102C8.44755 13.6557 9.4789 12 12.0004 12C14.5219 12 15.5533 13.6557 15.8773 15.0102C16.0057 15.5473 15.5527 16 15.0004 16H9.0004C8.44812 16 7.99507 15.5473 8.12355 15.0102Z"
      fill="currentColor"
    />
    <path
      fillRule="evenodd"
...
export default SvgContactAgenda;
