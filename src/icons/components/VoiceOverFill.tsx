...
const SvgVoiceOverFill = (props: SVGProps<SVGSVGElement>) => (
  <svg
    fill="currentColor"
  ...
  >
    <path
      d="M8 6C8 3.79086 9.79086 2 12 2C14.2091 2 16 3.79086 16 6V13C16 15.2091 14.2091 17 12 17C9.79086 17 8 15.2091 8 13V6Z"
      fill="currentColor"
    />
    <path
...
export default SvgVoiceOverFill;
