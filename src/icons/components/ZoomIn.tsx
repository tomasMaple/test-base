...
const SvgZoomIn = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M14.9393 15.9393C15.5251 15.3536 16.4749 15.3536 17.0607 15.9393L20.5607 19.4393C21.1464 20.0251 21.1464 20.9749 20.5607 21.5607C19.9749 22.1464 19.0251 22.1464 18.4393 21.5607L14.9393 18.0607C14.3536 17.4749 14.3536 16.5251 14.9393 15.9393Z"
      fill="currentColor"
    />
    <path
      fillRule="evenodd"
    ...
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M10 7C10.5523 7 11 7.44772 11 8V14C11 14.5523 10.5523 15 10 15C9.44771 15 9 14.5523 9 14L9 8C9 7.44772 9.44771 7 10 7Z"
      fill="currentColor"
    />
  </svg>
);
